  ...
  return (
    <div className={styles.disclaimer}>
      <header className={styles.header}>
        <h1>Disclaimer</h1>
        <p className={styles.lastUpdated}>Last updated: May 07, 2025</p>
      </header>
      ...
      <div className={styles.content}>
        <section className={styles.section}>
          ...
          <ul className={styles.definitionList}>
            <li>
              ...
              "We", "Us" or "Our" in this Disclaimer) refers to Ocean Lifespaces
              India Private Limited, MF-1, Industrial Estate, CIPET Hostel Road,
            ...
            <li>
              <strong>Website</strong> refers to Ocean Lifespaces India Private
              Limited, accessible from https://www.olipl.com/
            </li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            created with the help of the Disclaimer Generator.
          </p>
          <p>
        ...
        <section className={styles.section}>
          ...
          <p>
            By email:{" "}
            <a href="mailto:info@olipl.com" className={styles.emailLink}>
              info@olipl.com
            </a>
          </p>
        </section>
...
export const metadata = {
  title: "Disclaimer | Ocean Lifespaces India Pvt Ltd",
  description:
