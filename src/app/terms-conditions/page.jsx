  ...
  return (
    <div className={styles.termsContainer}>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.definitionList}>
            ...
            <li>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Ocean Lifespaces
        ...
        <section className={`${styles.section} ${styles.important}`}>
        ...
        <section className={styles.section}>
          ...
          <p>
            By email:{" "}
            <a href="mailto:contracts@olipl.com" className={styles.emailLink}>
              contracts@olipl.com
            </a>
          </p>
        </section>
